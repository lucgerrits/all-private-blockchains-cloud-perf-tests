...
$ cd dataSet/
$ cp accumulation.py iteratiorMeasures.sh measurmentTest.sh ../
$ cd ..

```

#### Second step: 
##### in iteratiorMeasures.sh set value, results are stored in dataSet/measurements/measurementResults.tx

```
$ ./iteratiorMeasures.sh
```